...
class Ui_PluginWindow(object):
    ...
    def retranslateUi(self, PluginWindow):
        ...
        self.gnome_lineEdit_light.setPlaceholderText(_translate("PluginWindow", "Light Theme"))
        self.gnome_lineEdit_dark.setPlaceholderText(_translate("PluginWindow", "Dark Theme"))
