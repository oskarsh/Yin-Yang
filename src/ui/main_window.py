...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        main_window.setMinimumSize(QSize(377, 0))
        ...
        sizePolicy1.setHeightForWidth(self.inp_time_light.sizePolicy().hasHeightForWidth())
        self.inp_time_light.setSizePolicy(sizePolicy1)
        ...
        sizePolicy1.setHeightForWidth(self.inp_time_dark.sizePolicy().hasHeightForWidth())
        self.inp_time_dark.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.inp_longitude.sizePolicy().hasHeightForWidth())
        self.inp_longitude.setSizePolicy(sizePolicy2)
        ...
        sizePolicy1.setHeightForWidth(self.inp_latitude.sizePolicy().hasHeightForWidth())
        self.inp_latitude.setSizePolicy(sizePolicy1)
        ...
        self.plugins_scroll_content.setGeometry(QRect(0, 0, 359, 411))
